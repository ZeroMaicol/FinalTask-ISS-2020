...
public class Test_SPRINT_2_plasticBox_full {
	...
	public void sprint_1_Test() {
		...
		assertTrue("detector has already emptied his box?", detectorBoxClient.get().getResponseText().substring(0, 1).equals("0"));
		...
		assertTrue("plastic box has not received a bottle because is full?", plasticBoxClient.get().getResponseText().substring(0, 2).equals("10"));
	}
