		...
		return { //this:ActionBasciFsm
					...
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("terminate(X)"), Term.createTerm("terminate(X)"), 
								...
								robotWasExploring = false
								 ...
								 { kotlincode.coapSupport.updateResource(myself ,"wroom/robotCommand", "waiting" )
								  }
								 }
						}
					}
				...
				state("executeHomeMove") { //this:State
					action { //it:State
						...
						kotlincode.coapSupport.updateResource(myself ,"wroom/robotCommand", "home" )
						 }
						else
						 { delay(500) 
					...
					transition(edgeName="t19",targetState="goHome",cond=whenDispatch("suspend"))
					transition(edgeName="t110",targetState="terminateTask",cond=whenDispatch("terminate"))
				}	 
				state("executeBottlesTransfer") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t011",targetState="doPlannedMoves",cond=whenDispatch("moveOk"))
					transition(edgeName="t012",targetState="work",cond=whenDispatch("backHome"))
				}	 
				...
				state("doMove") { //this:State
					...
					transition(edgeName="t114",targetState="doPlannedMoves",cond=whenReply("stepdone"))
					transition(edgeName="t115",targetState="onStepFail",cond=whenReply("stepfail"))
					transition(edgeName="t116",targetState="goHome",cond=whenDispatch("suspend"))
					transition(edgeName="t117",targetState="terminateTask",cond=whenDispatch("terminate"))
				}	 
				state("onStepFail") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t118",targetState="afterStepFail",cond=whenReply("stepdone"))
				}	 
				state("afterStepFail") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t119",targetState="doPlannedMoves",cond=whenDispatch("moveOk"))
					transition(edgeName="t120",targetState="doExplore",cond=whenDispatch("obstacleFound"))
					transition(edgeName="t121",targetState="goHome",cond=whenDispatch("detectorMustEmpty"))
					transition(edgeName="t122",targetState="waitForCommand",cond=whenDispatch("detectorCantEmpty"))
					transition(edgeName="t123",targetState="goHome",cond=whenDispatch("suspend"))
					transition(edgeName="t124",targetState="terminateTask",cond=whenDispatch("terminate"))
				}	 
			}
		}
}
