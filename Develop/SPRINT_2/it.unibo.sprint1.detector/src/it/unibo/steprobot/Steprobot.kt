		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="s016",targetState="handleCmd",cond=whenDispatch("cmd"))
					transition(edgeName="s017",targetState="doStep",cond=whenRequest("onestep"))
					transition(edgeName="s018",targetState="doStepBackwards",cond=whenRequest("onestepbackwards"))
				}	 
				...
				state("doStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t019",targetState="stepDone",cond=whenTimeout("local_tout_steprobot_doStep"))   
					transition(edgeName="t020",targetState="stepFailVirtual",cond=whenEvent("virtualobstacle"))
				}	 
				state("doStepBackwards") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t021",targetState="stepBackwardsDone",cond=whenTimeout("local_tout_steprobot_doStepBackwards"))   
				}	 
